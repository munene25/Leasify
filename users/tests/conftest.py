...
@dataclass
class UserData:
    first_name: str = field(default=_fake.first_name())
    last_name: str = field(default=_fake.last_name())
    email: str = field(default=_fake.email())
    password: str = field(default=_fake.password())
