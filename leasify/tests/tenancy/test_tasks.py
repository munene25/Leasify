...
from leasify.tenancy.choices import TenancyStatus as TS, TerminationReason as TS
from leasify.tenancy.tasks import *
from freezegun import freeze_time
from django.utils import timezone
from leasify.common.period import today as _today
