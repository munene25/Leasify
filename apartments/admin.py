...
class ApartmentAdmin(admin.ModelAdmin):
    list_display = ("apartment_name", "rentable", "rent", "occupied")
    ...
    readonly_fields = ("occupied", "current_tenant", "created_at")
    ...
    occupied.short_description = "Currently occupied"
    ...
    def get_queryset(self, request: HttpRequest) -> QuerySet:
        ...
        return (
            ...
            .prefetch_related(tenancy_prefetch())
        )
