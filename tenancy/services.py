...
from tenancy.choices import Status
...
def tenancy_renew_lease(tenancy: Tenancy, duration_months: int):
    ...
    billing_period_increment(tenancy=tenancy, duration_months=duration_months)