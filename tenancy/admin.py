...
class TenancyAdmin(admin.ModelAdmin):
    ...
    search_fields = ("tenant__user__first_name", "tenant__user__last_name", "apartment__unit_number", "apartment__block__name")
    ...
    def apartment_name(self, obj):
        ...
        return format_html('<a href="{}">{}</a>', url, obj.apartment.apartment_name)
